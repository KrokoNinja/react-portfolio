    ...
    <>
      <div className="container about-page">
        <div className="text-zone">
          ...
          <p>
            I'm a self-taught Frontend Developer deeply passionate about
            crafting captivating web experiences. Knowing the fundamentals of
            HTML, CSS, and JavaScript, I like translating imaginative designs
            into seamless, user-friendly websites.
          </p>
          <p>
